// app/api/mcp/subscriptions/subscribe/route.ts
// POST /api/mcp/subscriptions/subscribe - Subscribe to resource updates (server-side)
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, data: { uri, subscribed: true } });
  } catch (error) {
    return NextResponse.json(
