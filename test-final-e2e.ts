...
import { SimplyMCP } from '/mnt/Shared/cs-projects/simple-mcp/mcp/index.js';
...
async function finalE2ETest() {
  ...
  try {
    ...
    const weatherServerPath = '/mnt/Shared/cs-projects/simple-mcp/weather-server-e2e.ts';
    ...
    const decoratorServerPath = '/mnt/Shared/cs-projects/simple-mcp/decorator-server-e2e.ts';
