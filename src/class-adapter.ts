 ...
 *
 * Example (deprecated):
 *   npx tsx src/class-adapter.ts examples/class-basic.ts --http --port 3000
 *
 * Example (recommended):
 *   simplymcp run examples/class-basic.ts --http --port 3000
 *   simplymcp-class examples/class-basic.ts --http --port 3000
 */
...
Usage:
  npx tsx src/class-adapter.ts <class-file.ts> [options]
...
Example:
  npx tsx src/class-adapter.ts examples/class-basic.ts
  npx tsx src/class-adapter.ts examples/class-basic.ts --http --port 3000
`);
    process.exit(0);
  }
