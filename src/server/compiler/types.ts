...
export interface ParsedTool {
  ...
  hidden?: boolean;
  /** Whether hidden field is a function (detected at compile time) @since v4.5.0 */
  hiddenIsDynamic?: boolean;
...
/**
 * Parsed skill interface metadata
 */
export interface ParsedSkill {
  /** Original interface name */
  interfaceName: string;
  /** Skill name from interface (snake_case) */
  name: string;
  /** Skill description (trigger phrase) */
  description: string;
  /** Expected method name (camelCase) - derived from skill name */
  methodName: string;
  /** Return type information (should be 'string' for markdown) */
  returnsType: string;
  /** Raw TypeScript node for returns field */
  returnsNode?: ts.TypeNode;
  /** Hide from skills/list endpoint @since v4.4.0 */
  hidden?: boolean;
  /** Whether hidden field is a function (detected at compile time) @since v4.5.0 */
  hiddenIsDynamic?: boolean;

  /**
   * Resource URI for MCP resources/* endpoint
   * Generated as `skill://${name}`
   * @since v4.7.0
   */
  uri: string;

  /**
   * MIME type for skill content (always 'text/markdown')
   * @since v4.7.0
   */
  mimeType: string;

  /**
   * Skill content field (preferred over deprecated 'returns')
   ...
   * Flat array from ISkill.resources
   * @since v4.7.0
   */
  resources?: string[];
   ...
   * Flat array from ISkill.prompts
   * @since v4.7.0
   */
  prompts?: string[];
  ...
  /**
   * Flag indicating this skill uses auto-generation
   * When true, content is generated from tools/resources/prompts at runtime
   * When false, content comes from manual skill field
   * @since v4.6.0
   */
...
export interface ParseResult {
  ...
  /** Skill validation warnings (FT-3) @since v4.6.0 */
  skillValidationWarnings?: import('./validators/types.js').ValidationWarning[];
}
