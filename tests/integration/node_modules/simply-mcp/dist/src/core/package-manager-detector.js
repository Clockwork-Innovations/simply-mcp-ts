 ...
 * ```
 */
export async function detectPackageManager(cwd, preferred) {
    const workingDir = cwd || process.cwd();
    // If preferred is specified, verify it and use it
    if (preferred && preferred !== 'auto') {
        const pmName = preferred;
 ...
 * ```
 */
export async function isPackageManagerAvailable(name) {
    try {
 ...
 * ```
 */
export async function getPackageManagerVersion(name) {
    try {
 ...
 * ```
 */
export function getLockFileName(name) {
    const lockFiles = {
