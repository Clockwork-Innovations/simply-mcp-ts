 ...
 */
export async function formatOutput(options, buildResult, deps) {
 ...
 */
async function formatStandalone(options, buildResult, deps) {
 ...
 */
function generateReadme(options, deps) {
    const bundleFilename = basename(options.output);
 ...
 */
export async function createShellWrapper(bundlePath, name) {
 ...
 */
export async function createBatchWrapper(bundlePath, name) {
