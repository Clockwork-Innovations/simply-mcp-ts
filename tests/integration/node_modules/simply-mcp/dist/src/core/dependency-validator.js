 ...
 * ```
 */
export function validateSemverRange(version) {
    // Empty version
 ...
 * ```
 */
export function detectConflicts(deps) {
    const seen = new Map();
    const conflicts = [];
 ...
 */
export function areVersionsIncompatible(version1, version2) {
    // If they're identical, definitely compatible
    if (version1 === version2) {
        return false;
    }
    // Wildcards are always considered compatible
    if (VALID_KEYWORDS.includes(version1) ||
