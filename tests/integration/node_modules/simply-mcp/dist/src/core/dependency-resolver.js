 ...
 */
export function detectNativeModules(dependencies) {
 ...
 */
export function isNativeModule(packageName) {
 ...
 */
export function mergeDependencies(...sources) {
    const merged = {};
 ...
 * ```
 */
export function filterDependencies(dependencies, patterns, include = true) {
    const filtered = {};
 ...
 */
export async function detectPeerDependencies(basePath) {
    const pkgPath = join(basePath, 'package.json');
    if (!existsSync(pkgPath)) {
        return [];
    }
