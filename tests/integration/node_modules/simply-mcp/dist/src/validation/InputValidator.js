...
import { SchemaValidationError, ValidationError } from './ValidationError.js';
/**
...
export class InputValidator {
     ...
     */
    validateToolArguments(args, schema, options) {
     ...
     */
    safeParse(value, schema) {
        return this.validateToolArguments(value, schema);
    }
    /**
     * Parse and throw on error
     */
    parse(value, schema) {
        const result = this.validateToolArguments(value, schema);
        if (!result.valid) {
     ...
     */
    getSchemaCacheKey(schema, options) {
...
export function validateToolArguments(args, schema, options) {
    return defaultValidator.validateToolArguments(args, schema, options);
}
export function validateField(value, schema, fieldName) {
    return defaultValidator.validateField(value, schema, fieldName);
}
export function safeParse(value, schema) {
    return defaultValidator.safeParse(value, schema);
}
export function parse(value, schema) {
    return defaultValidator.parse(value, schema);
}
