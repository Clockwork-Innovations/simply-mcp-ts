 ...
 * Audit event types
 */
export type AuditEventType = 'authentication.success' | 'authentication.failure' | 'authentication.missing' | 'authorization.granted' | 'authorization.denied' | 'tool.executed' | 'tool.failed' | 'ratelimit.exceeded' | 'ratelimit.warning' | 'session.created' | 'session.terminated' | 'security.violation';
/**
 * Audit log entry
 */
