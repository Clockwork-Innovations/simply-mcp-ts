 ...
 */
export type SchemaType = 'string' | 'number' | 'boolean' | 'object' | 'array' | 'date' | 'email' | 'url' | 'uuid' | 'enum';
/**
 ...
 */
export type Schema = StringSchema | NumberSchema | BooleanSchema | EnumSchema | ArraySchema | ObjectSchema | DateSchema;
