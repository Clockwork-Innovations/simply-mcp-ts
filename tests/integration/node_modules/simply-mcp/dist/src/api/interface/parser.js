 ...
 */
export function parseInterfaceFile(filePath) {
 ...
 */
function parseToolInterface(node, sourceFile) {
    const interfaceName = node.name.text;
    let name = '';
    let description = '';
    let paramsType = 'any';
 ...
 */
function parsePromptInterface(node, sourceFile) {
    const interfaceName = node.name.text;
    let name = '';
    let description = '';
    let template;
 ...
 */
function parseResourceInterface(node, sourceFile) {
    const interfaceName = node.name.text;
    let uri = '';
    let name = '';
    let description = '';
 ...
 */
function parseServerInterface(node, sourceFile) {
    const interfaceName = node.name.text;
    let name = '';
    let version = '';
    let description;
