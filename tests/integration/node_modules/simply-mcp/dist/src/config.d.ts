 ...
 */
export type { CLIConfig, ServerConfig, DefaultsConfig, RunConfig, BundleConfig, APIStyle, TransportType, } from './cli/cli-config-loader.js';
 ...
 * ```
 */
export declare function defineConfig(config: CLIConfig): CLIConfig;
