...
# CLI command
CLI="node $PROJECT_ROOT/dist/src/cli/index.js"

# Test servers
SERVER1="$PROJECT_ROOT/examples/class-minimal.ts"
SERVER2="$PROJECT_ROOT/examples/class-basic.ts"
SERVER3="$PROJECT_ROOT/examples/single-file-basic.ts"
