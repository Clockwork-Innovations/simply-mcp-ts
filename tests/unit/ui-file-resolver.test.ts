...
import { testIfCanEnforceFilePermissions } from '../utils/conditional-tests.js';
...
describe('UI File Resolver', () => {
  ...
  describe('File Loading', () => {
    ...
    testIfCanEnforceFilePermissions('should handle permission errors gracefully', async () => {
