...
import { ServerConfig, ToolConfig } from '../../../src/types.js';
import { validateAndSanitize } from '../../../src/features/validation/index.js';
import { HandlerManager } from '../../../src/core/HandlerManager.js';
import { createDefaultLogger } from '../../../src/core/logger.js';
import { HandlerExecutionError } from '../../../src/core/errors.js';
...
// CLI entry point
const configPath = process.argv[2] || 'tests/fixtures/config/config-test.json';
